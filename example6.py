...
dislike = cv2.pyrDown(cv2.pyrDown(dislike))
...
def match_emoji(grayscale, frame, template, emoji, threshold):
...
while True: 
    ...
    frame = match_emoji(grayscale, frame, like, like_emoji, threshold1)
    frame = match_emoji(grayscale, frame, dislike, dislike_emoji, threshold2)
